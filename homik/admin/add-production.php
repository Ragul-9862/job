...
if (strlen($_SESSION['aid'] == 0)) {
    ...
    <head>
        ...
        <title>Add Production Process</title>
            ...
            <div class="hk-pg-wrapper">
                ...
                <div class="container">
                    <div class="hk-pg-header">
                        <h4 class="hk-pg-title">Add Production Process</h4>
                    </div>
                                        ...
                                        <form class="needs-validation" action="insert.php" method="post" novalidate enctype="multipart/form-data">
                                            <div class="form-row">
                                                <div class="col-md-6 mb-10">
                                                    <label for="title">Prod Process</label>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6 mb-10">
                                                    <label for="image">Prod Process Image</label>
                                                    <input class="form-control" type="file" name="image" required>
                                                    <div class="invalid-feedback">Please provide a valid image.</div>
                                                </div>
                                            </div>

                                            <button class="btn btn-primary" type="submit" name="processsubmit">Submit</button>
                                        </form>
                                    </div>
                                </div>
                            </section>
