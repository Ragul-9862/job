...
if (strlen($_SESSION['aid']) == 0) {
    ...
    if (isset($_POST['update_blog'])) {
        ...
        // Update query
        $update_query = "UPDATE blog SET title='$title', content='$content', image='$image_path' WHERE id='$blog_id'";
        
        if (mysqli_query($con, $update_query)) {
            $_SESSION['successMsg'] = "Blog updated successfully!";
            header('location:manage_blog.php');
        } else {
            $_SESSION['error'] = "Error updating blog: " . mysqli_error($con);
        }
    }
?>
                    ...
                    <div class="col-xl-12">
                        <section class="hk-sec-wrapper">
                            ...
                            <form class="needs-validation" action="" method="post" enctype="multipart/form-data" novalidate>
                                ...
                                <button class="btn btn-primary" type="submit" name="update_blog">Update</button>
                            </form>
                        </section>
                    </div>
                </div>
